...
#define HORI_GEM_VID                            0x24C6 // Hori Gem Controller for Xbox 360
...
#define HORI_GEM_PID                            0x550D // Hori Gem Controller for Xbox 360
...
public:
        ...
        virtual bool VIDPIDOK(uint16_t vid, uint16_t pid) {
                return ((vid == XBOX_VID || vid == MADCATZ_VID || vid == JOYTECH_VID || vid == GAMESTOP_VID || vid == HORI_GEM_VID)
                && (pid == XBOX_WIRED_PID || pid == MADCATZ_WIRED_PID || pid == GAMESTOP_WIRED_PID || pid == AFTERGLOW_WIRED_PID || pid == JOYTECH_WIRED_PID || pid == HORI_GEM_PID));
        };
        /**@}*/
